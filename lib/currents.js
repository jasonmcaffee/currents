...
class EventedProperty {
  ...
  handleAction(action) {
    let on = action.on,
        ...
        rest = _objectWithoutProperties(action, ['on', 'off', 'fire', 'setObject']);
 ...
 */
function setObjectBasedOnFullPath({ objectToSet, fullPathNames, value }) {
